...
Info.create(phone_number: '572-79-76 / 572-79-77', location: '192241, Санкт-Петербург, ул. Пражская, дом 12, корпус 1, «СПб ГУЗ Поликлиника городская №82 (гомеопатическая)»')
